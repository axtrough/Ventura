package net.raccoon.will.ventura.common.misc;
...
public class VArmorMaterials {
    private static final ResourceKey<EquipmentAsset> SLIDING_BOOTS_ASSET = ResourceKey.create(EquipmentAssets.ROOT_ID, Ventura.resLoc("sliding_boots"));
